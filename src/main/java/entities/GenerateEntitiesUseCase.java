...
public class GenerateEntitiesUseCase {
    ...
    /**
     * Extracts the AttributeMap corresponding to a Car from the given AttributeMap, and constructs that Car
     ...
     * @throws Exceptions.FactoryException if the needed submap is not present in map or does not contain the correct key/value pairs
     */
    ...
    /**
     * Extracts the AttributeMap corresponding to a CarBuyer from the given AttributeMap, and constructs that CarBuyer
     * @param map an AttributeMap with a submap containing keys and values corresponding to a CarBuyer
    ...
    /**
     * Extracts the ArrayAttribute corresponding to a list of AddOns from the given AttributeMap, and constructs that List of AddOns
     * @param map an AttributeMap containing an ArrayAttribute, where each value in the array is an AttributeMap corresponding to an AddOn
     * @return a List of AddOns constructed using the extracted ArrayAttribute of map
     * @throws Exceptions.FactoryException if the needed ArrayAttribute is not present in map or does not contain the correct key/value pairs
     */
    ...
    /**
     * Extracts the AttributeMap corresponding to a LoanData from the given AttributeMap, and constructs that LoanData
     * @param map an AttributeMap with a submap containing keys and values corresponding to a LoanData
