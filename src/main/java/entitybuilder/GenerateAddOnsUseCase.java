...
public class GenerateAddOnsUseCase {
  /**
   * Takes a list of addon names and generates a mapping of addon names to their corresponding AddOn
   * objects
   *
  ...
  public HashMap<String, AddOn> GenerateAddOnsUseCase(List<String> ListOfAddOnNames) {
    /**
     * A mapping of the name of the addons we get from the list of addons in our parameter to the
     * AddOn objects with the corresponding name which we create below
     */
