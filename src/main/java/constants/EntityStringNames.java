 ...
 * These are the keys used in Attributized versions of the entities,
 * as well as the keys expected to be present in data received from the frontend.
 * Having them all as constants here ensures consistency throughout the program.
 * */
