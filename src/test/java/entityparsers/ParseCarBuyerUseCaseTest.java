...
public class ParseCarBuyerUseCaseTest {
  ...
  /**
   * Test that ParseBuyerUseCase correctly throws a ParseException when the types of objects in the
   * JSONObject don't match the needed types for creating a CarBuyer
   */
  @Test
  ...
  /**
   * Test that ParseCarBuyerUseCase correctly throws a ParseException when the JSONObject attribute
   * names needed for creating a CarBuyer either don't match or don't exist in the JsonObject
   */
  @Test
