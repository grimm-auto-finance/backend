...
public class AttributeMapTest {
  ...
  public void TestaddItemAttributeAndGet() {
    ...
    assertEquals(
        new IntAttribute(1).getAttribute(), attMap.getItem("integer_Attribute").getAttribute());
  }
  ...
  public void TestaddItemObjectAndGet() {
    ...
    assertEquals(
        new IntAttribute(1).getAttribute(), attMap.getItem("integer_Object").getAttribute());
  }
