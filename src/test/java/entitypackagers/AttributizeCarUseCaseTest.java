...
public class AttributizeCarUseCaseTest {
  ...
  public void testAttributizeCarWithAddOns() {
    ...
    addOnMap.addItem(
        "Rust proofing " + EntityStringNames.ADD_ON_STRING, addOnAttributizer.attributizeEntity());
    addOnAttributizer = new AttributizeAddOnUseCase(marshmallows);
    addOnMap.addItem(
        "Marshmallows " + EntityStringNames.ADD_ON_STRING, addOnAttributizer.attributizeEntity());
